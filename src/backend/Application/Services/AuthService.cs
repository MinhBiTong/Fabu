...
namespace Application.Services
{
    public class AuthService : IAuthService
    {
        ...
        public AuthService(IConfiguration configuration, IValidator<LoginRequest> validator,IResponseCacheService responseCache, IOptions<JwtConfiguration> jwtOptions, IUnitOfWork unitOfWork)
        {
